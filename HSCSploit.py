...
from core.HSCSploitcore.py import *
...
def main():
	...
	if lazymux == "1" or lazymux == "01":
		...
		print "    [30] pwnedOrNot"
		print "    [31] Mac-Lookup\n"
		print "    [00] Back to main menu|Выйти в главное меню\n"
		infogathering = raw_input("HSCSploit > ")
		...
		if infogathering == "01" or infogathering == "1":
			...
			print "\nERROR: Wrong Input|Неверный вариант"
			timeout(2)
			restart_program()
		...
		print "    [00] Back to main menu|Выйти в главное меню\n"
		stresstest = raw_input("HSCSploit > ")
		...
		print "    [14] ASU\n"
		print "    [00] Back to main menu|Выйти в главное меню\n"
		exploitool = raw_input("HSCSploit > ")
